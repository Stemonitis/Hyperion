...
def load_data_eo1hyperion(path_L1R):
    """you should pu here file with extension L1R or smth like that"""
    return SD(path_L1R,SDC.READ) #reads hdf file, attention: other hdf readers give an error: signature not found
...
"""You can pass the path as an argument to run this mod
if (__name__ == '__main__'):
    import sys
    if len(sys.argv) > 1:
        load_data_eo1hyperion(sys.argv)"""
